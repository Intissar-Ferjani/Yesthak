...
<div class="card">
    <div class="card-datatable table-responsive">
        <div class="dataTables_wrapper">
            <div class=" d-flex justify-content-between align-items-center mt-4 p-3 m-4">
                <h3><i class="fa-solid fa-layer-group"></i> Gérer <b>Catégories</b></h3>
                <!-- menu -->
    ...
    <table class="table border-top dataTable" style="width: 1210px;">
        ...
        <tr>
            ...
            <th rowspan="1" colspan="1" style="width: 299px; margin-left: 10px; font-size: 15px"><i class="fas fa-tag" style="color: blue"></i> Nom</th>
            ...
            <th rowspan="1" colspan="1" style="width: 332px; margin-left:10px; font-size: 15px">Classe d'icône</th>
