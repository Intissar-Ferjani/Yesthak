...
<div class="card">
    <div class="card-datatable table-responsive">
        <div class="dataTables_wrapper">
            <div class="container d-flex justify-content-between align-items-center mt-2 p-3">
                <h3><i class="fa-solid fa-layer-group"></i> Gérer <b><a href="{{ route('cagnottes.index') }}">Cagnottes</a></b></h3>
    ...
    <table class="table border-top dataTable" style="width: 1210px;">
        ...
        <tr>
            ...
            <th rowspan="1" colspan="1" style="width: 299px; margin-left: 10px; font-size: 15px"><i class="fa-solid fa-layer-group"></i> Category</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$pot->title}}</td>
                <td>{{$pot->amount}}</td>
                <td><img src="{{ Storage::url($pot->photo) }}" style="width:88px;height:82px; border-radius: 50%;"></td>
                <td>
                    <div>
